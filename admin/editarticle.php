...
<br><br><br><br>
        ...
        <tbody>
          ...
          ?>
              ...
              <tr>
                <td>标题</td>
                <td><input style="width:300px" type="text" name="title" value="<?php echo $row['title']?>"></td>
              </tr>
              ...
              <tr>
                <td>内容</td>
                <td>
                  <textarea cols="40"  rows="5"  style="width:400px;height:300px"  type="text" name="content" >

...
if ($row['sex']==1) {
 ...
 <p style='font-size:30px;float: right'>
     <a class="btn_cart float_r" href="edituserinfo.php?uid=<?php echo $uid?>">修改信息</a><br>
     <a class="btn_cart float_r" href="upload.php?uid=<?php echo $uid?>">上传头像</a><br>
     <a class="btn_cart float_r" href="order.php?uid=<?php echo $uid?>">我的订单</a>
 </p>

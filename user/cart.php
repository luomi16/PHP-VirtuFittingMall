...
<hr>
 ...
 ?> </p>
 <p style='font-size:12px;'><a class="btn_cart float_r" href="payall.php?uid=<?php echo $uid?>">全部付款</a></p>
 <p style='font-size:12px'><a class="btn_cart float_r" href="cleancart.php?uid=<?php echo $uid?>">清空购物车</a></p>

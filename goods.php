        ...
        ?>
         ...
         <div class="gatt module">
          <form method="post" action="user/buy.php?gid=<?php echo $goods_id?>&uid=<?php echo $uid?>" id="buy-form">
           ...
           <button id="addcart" name="addcart" type="button" class="buynow">加入购物车</button><br>
           <button id="try-on" name="try-on" type="button" class="try-on">点击试穿</button>
           </form>
         </div>
       </div>
     </div>
...
$(function(){
  $('#try-on').click(function(){
    location.href ="clothes/room.php?uid=<?php echo $uid?>&gid=<?php echo $goods_id?>";
  });
});
</script>
